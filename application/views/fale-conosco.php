...
<div class="container">
    ...
    <div class="row">
        ...
        <?php	
            ...
            <form class="form-horizontal" method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <textarea class="form-control" id="mensagem" name="mensagem" rows="10" placeholder="mensagem"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-10">
        ...
        <div class="col-md-4">
            ...
            <h4>Endereço</h4>
            <p>R. Quinze de Novembro - Praia da Costa, Vila Velha - ES</p> <hr />
            <div class="embed-responsive embed-responsive-4by3">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe> 
            </div>
        </div>
    </div>
</div>
